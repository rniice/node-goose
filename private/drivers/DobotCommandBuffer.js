...
//create buffer to send to dobot from desired values from sendDobotState
DobotCommandBuffer.prototype.generateCommandBuffer = function(data) {
	...
	if(data.jog === true) {																//Jog Mode: Incremental, Linear (state = 7) or Angular (state = 2)
		...
		command_buffer.writeFloatLE(data.head_rot, 21);	//write the rotation_head [data.head_rot]
